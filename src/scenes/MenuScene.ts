...
export class MenuScene extends Phaser.Scene {
  private prototypes: PrototypeItem[] = [
    ...
    {
      key: 'BlindBoxCasinoScene',
      name: '盲盒赌场',
      description: '戴罗马面具闯进废弃剧院开盲盒！按住空格敲盲盒→物品掉地上→E捡进4格背包→Q随时卖掉已知价值物品！未鉴定物品必须找商人鉴定才能卖（宝贝还是垃圾？）。左键扔手持物品砸怪眩晕——便宜东西扔了不心疼，贵东西留着卖！E躲进躲避点断视线脱仇恨！群演幽灵靠视线（有领地不会全图追），掌声判定者靠听觉——蹲走(Ctrl)无声隐身！Shift疾跑(有声) | Ctrl蹲走(无声) | 空格敲盒 | 左键扔 | Q卖 | E捡/躲藏/鉴定/撤离 | 滚轮切换',
    },
    {
      key: 'BoxSmashScene',
      name: '砸盒惊魂',
    ...
    },
    {
      key: 'BoxHeistScene',
      name: '砸盒劫案',
      description: '砸小盒子捡钱/手雷/急救包/未鉴定物！大盒子蛮力打不开，扔钱币或手雷炸开！空手右键每次扔¥1，按123切换手持道具后右键扔出。急救包可放入背包，手持左键砸开或右键扔出，生成短暂回血区！未鉴定物找鉴定机按E鉴定。攒够¥1000回入口撤离！左键捡/敲 | Q放下 | Shift疾跑',
    },
